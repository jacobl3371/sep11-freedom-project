...
We also need to have a `vercel.json` file in our backend directory which holds the appropriate dependancies to allow for our backend to be hosted to vercel.
